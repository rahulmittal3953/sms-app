...
var StudentDetailComponent = /** @class */ (function () {
    function StudentDetailComponent(studentService, notif, router, ngProgress, route, classService, feeTypeService) {
        ...
        this.itemResource = new __WEBPACK_IMPORTED_MODULE_4_angular5_data_table__["b" /* DataTableResource */](this.studentFeeParams);
        this.items = [];
        this.itemCount = 0;
        this.params = { offset: 0, limit: 10 };
        this.route.params.subscribe(function (params) {
    ...
    StudentDetailComponent.prototype.getStudentFee = function () {
        ...
        this.studentService
            ...
            if (!_this.studentFee) {
                ...
                _this.ngProgress.done();
                _this.itemResource = new __WEBPACK_IMPORTED_MODULE_4_angular5_data_table__["b" /* DataTableResource */](_this.studentFeeParams);
                _this.reloadItems(_this.params);
                _this.itemResource.count().then(function (count) { return _this.itemCount = count; });
            }
        }, function (error) {
    ...
    StudentDetailComponent.prototype.reloadItems = function (params) {
        var _this = this;
        console.log("reload");
        this.itemResource.query(params).then(function (items) { return _this.items = items; });
    };
...
var UpdateStudentComponent = /** @class */ (function () {
    ...
    UpdateStudentComponent.prototype.reloadItems = function (params) {
        var _this = this;
        console.log("reload");
        this.itemResource.query(params).then(function (items) { return _this.items = items; });
    };
...
var AuthenticationService = /** @class */ (function () {
    function AuthenticationService(http) {
        this.http = http;
        this.apiURl = "https://ngschooldemo.herokuapp.com"; //"http://localhost:8080";
